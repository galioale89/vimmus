...
router.get('/dimensionamento/', ehAdmin, (req, res) => {
     ...
     var th3 = 'white'
     var td3 = 'none'
     res.render('projeto/dimensionamento', { th2, td2, th3, td3 })
})

router.post('/dimensionar', ehAdmin, (req, res) => {
     var dime
     Dimensionamento.findOneAndRemove({ _id: req.body.id }).then(() => {
     }).catch((err) => {
          ...
          new Dimensionamento(dime).save().then(() => {
               Dimensionamento.findOne().sort({ field: 'asc', _id: -1 }).lean().then((dimensionamento) => {
                    ...
                    res.render('projeto/dimensionamento', { dimensionamento })
               }).catch((err) => {
